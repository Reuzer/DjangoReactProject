# Generated by Django 5.1.4 on 2025-05-10 22:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_reports', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='FavoriteReportItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('added_at', models.DateTimeField(auto_now_add=True)),
                ('favorite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='animalSearch.favoritereports')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='favoritereports',
            name='reports',
            field=models.ManyToManyField(related_name='favorited_by', through='animalSearch.FavoriteReportItem', to='animalSearch.pet_report', verbose_name='Объявления'),
        ),
        migrations.AddField(
            model_name='favoritereportitem',
            name='report',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='animalSearch.pet_report'),
        ),
        migrations.AddField(
            model_name='breed',
            name='pet_type_id',
