# Generated by Django 5.1.4 on 2025-04-17 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('pet_type_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='animalSearch.pet_type', verbose_name='Животное')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_reports', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_type_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='animalSearch.pet_type', verbose_name='Животное')),
            ],
            options={
                'verbose_name': 'Порода',
